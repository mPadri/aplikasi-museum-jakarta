...
public class ListJaktim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_jaktim);
        ...
        loading =  ProgressDialog.show(ListJaktim.this,
                null,
                "Mohon Tunggu...",
                true,
                false);

        database.child("JakartaTimur").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                requestAdapterRecyclerView = new RequestAdapterRecyclerView(daftarReq, ListJaktim.this);
