...
public class ListJaksel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_jaksel);
        ...
        loading =  ProgressDialog.show(ListJaksel.this,
                null,
                "Mohon Tunggu...",
                true,
                false);

        database.child("JakartaSelatan").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                requestAdapterRecyclerView = new RequestAdapterRecyclerView(daftarReq, ListJaksel.this);
