...
public class ListJakpus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_jakpus);
        ...
        loading =  ProgressDialog.show(ListJakpus.this,
                null,
                "Mohon Tunggu...",
                true,
                false);

        database.child("JakartaPusat").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                requestAdapterRecyclerView = new RequestAdapterRecyclerView(daftarReq, ListJakpus.this);
