...
public class ListJakut extends AppCompatActivity {
...
private ProgressDialog loading;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_jakut);
        ...
        loading =  ProgressDialog.show(ListJakut.this,
                null,
                "Mohon Tunggu...",
                true,
                false);

        database.child("JakartaUtara").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                requestAdapterRecyclerView = new RequestAdapterRecyclerView(daftarReq, ListJakut.this);
